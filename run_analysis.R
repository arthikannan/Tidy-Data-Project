...
x_train <- read.table("C:\\Users\\mail2\\Documents\\GitHub\\Tidy-Data-Project\\UCI HAR Dataset\\train\\X_train.txt",
                      header=FALSE,fill=TRUE)

# Reading the features list and assiging it as column names of X_train
x_features <- read.table("C:\\Users\\mail2\\Documents\\GitHub\\Tidy-Data-Project\\UCI HAR Dataset\\features.txt",
                         header=FALSE)
...
y_train <- read.table("C:\\Users\\mail2\\Documents\\GitHub\\Tidy-Data-Project\\UCI HAR Dataset\\train\\y_train.txt",
                      header=FALSE,fill=TRUE)
...
sub_train <- read.table("C:\\Users\\mail2\\Documents\\GitHub\\Tidy-Data-Project\\UCI HAR Dataset\\train\\subject_train.txt",
                            header=FALSE,fill=TRUE)
...
x_test <- read.table("C:\\Users\\mail2\\Documents\\GitHub\\Tidy-Data-Project\\UCI HAR Dataset\\test\\X_test.txt",
                      header=FALSE,fill=TRUE)
...
y_test <- read.table("C:\\Users\\mail2\\Documents\\GitHub\\Tidy-Data-Project\\UCI HAR Dataset\\test\\y_test.txt",
                      header=FALSE,fill=TRUE)
...
sub_test <- read.table("C:\\Users\\mail2\\Documents\\GitHub\\Tidy-Data-Project\\UCI HAR Dataset\\test\\subject_test.txt",
                        header=FALSE,fill=TRUE)
